...
describe('9 - Implemente os casos de teste da função `getCharacter`', () => {
  ...
  it('Verifica se a função `getCharacter` retorna o objeto esperado para o parâmetro `Arya`', () => {
    expect(getCharacter('Arya')).toEqual({
      name: 'Arya Stark',
      class: 'Rogue',
      phrases: ['Not today', 'A girl has no name.']
  ...
  it('Verifica se a função `getCharacter` retorna o objeto esperado para o parâmetro `Brienne`', () => {
  ...
  it('Verifica se a função `getCharacter` retorna o objeto esperado para o parâmetro `Melissandre`', () => {
  ...
  it('Verifica se o parâmetro não é Case Sensitive, ou seja, independente de conter letras maiúsculas ou minúsculas retorna o mesmo objeto relativo a ele.', () => {
    expect(getCharacter('James')).toBeUndefined();
  });
