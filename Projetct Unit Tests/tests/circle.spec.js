...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  ...
  it('Verifica se a função retorna um objeto com três propriedades', () => {
  ...
  it('Verifica se a função retorna a circunferência correta, para um dado valor de número 2', () => {
    expect(circle(2).circumference).toEqual(12.56);
  });
  it('Verifica se a função retorna a área correta, para um dado valor de número 3', () => {
